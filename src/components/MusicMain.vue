            ...
            <div class="container">
                <div class="row">
                    <div class="col-1">
                        ...
                        <div class="row pt-3 pb-2" style="height: 60px; text-align: center; align-items: center;">
                            <p>2</p>
                        </div>
                        <div class="row pt-4 pb-2" style="height: 55px; text-align: center; align-items: center;">
                            <p>3</p>
                        </div>
                        <div class="row pt-4 pb-2" style="height: 55px; text-align: center; align-items: center;">
                            <p>4</p>
